...
class GRUCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b_z = tf.get_variable("b_z", shape=(self.state_size,), initializer=constant)
            ...
            b_r = tf.get_variable("b_r", shape=(self.state_size,), initializer=constant)
            ...
            b_o = tf.get_variable("b_o", shape=(self.state_size,), initializer=constant)
