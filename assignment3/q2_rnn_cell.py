...
class RNNCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_x = tf.get_variable("W_x", shape=(self.input_size, self.state_size), initializer=xavier)
            W_h = tf.get_variable("W_h", shape=(self.state_size, self.state_size), initializer=xavier)
            b = tf.get_variable("b", shape=(self.state_size,), initializer=constant)
